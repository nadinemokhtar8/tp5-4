...
class __TwigTemplate_09afc2f27601c306542d6ab9aad1aa9a extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"card-body\">
            ...
            ";
        // line 9
        yield from $this->load("articles/_form.html.twig", 9)->unwrap()->yield(CoreExtension::merge($context, ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "button_label" => "Modifier"]));
        // line 10
        yield "        </div>
    </div>
";
...
{% block body %}
    <div class=\"card shadow-sm\">
        <div class=\"card-body\">
            <h1 class=\"h3 mb-4\">Modifier l'article</h1>
            {% include 'articles/_form.html.twig' with {form: form, button_label: 'Modifier'} %}
        </div>
    </div>
{% endblock %}
", "articles/edit.html.twig", "/app/templates/articles/edit.html.twig");
    }
}
